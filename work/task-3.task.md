...
- Feed updates from network service discovery (PORT_ZERO) to the overlay
...
- [ ] Services with PORT_ZERO are registered in overlay
- [ ] Stack shuts down cleanly
- [ ] No breakage to existing PORT_ZERO flow
